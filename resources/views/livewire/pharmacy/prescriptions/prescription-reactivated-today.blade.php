<div>
    <x-mary-header title="Reordered Today" separator />
    ...
    <div class="flex justify-center gap-2 mb-4 flex-wrap">
        ...
        <a href="{{ route('rx.reactivated-today') }}" class="btn btn-primary btn-sm" wire:navigate>
        ...
        <div class="overflow-x-auto">
            <table class="table table-zebra table-sm">
                ...
                <tbody>
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="text-xs opacity-60">PD #{{ $item->id }} | Rx #{{ $item->presc_id }}</div>
                            </td>
                            ...
                            <td class="text-xs">{{ $item->reordered_at ?? $item->active_date ?? 'N/A' }}</td>
                            <td>
                    ...
                    @empty
                        <tr>
                            <td colspan="13" class="text-center py-8 text-base-content/50">No reordered items found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
