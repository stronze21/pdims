<div>
    <x-mary-header title="Out Patient Department Prescriptions" separator />
    ...
    <div class="flex justify-center gap-2 mb-4">
        ...
        <a href="{{ route('rx.opd') }}" class="btn btn-primary btn-sm" wire:navigate>
            ...
            <table class="table table-zebra table-sm">
                ...
                <tbody>
                    @forelse ($prescriptions as $index => $rx)
                        ...
                        @if ($showRow)
                            <tr wire:key="opd-{{ $rx->enccode }}" wire:click="viewEncounter('{{ $rx->enccode }}')"
                                ...
                                <td class="whitespace-nowrap">
                                    ...
                                    <div class="text-xs opacity-70">
                                        {{ \Carbon\Carbon::parse($rx->opdtime)->format('g:i A') }}
                                    </div>
                                </td>
                                <td class="whitespace-nowrap">
                                ...
                                <td class="whitespace-nowrap">
                                    <div class="text-sm">Out Patient Department</div>
