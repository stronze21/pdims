...
#[Layout('layouts.app')]
#[Title('To Be Reordered Tomorrow')]
class PrescriptionReactivatesTomorrow extends Component
{
    ...
    public function render()
    {
        ...
        $items = $this->reactivationService
            ->reactivatesTomorrow($referenceDate)
        ...
        return view('livewire.pharmacy.prescriptions.prescription-reactivates-tomorrow', [
            'items' => $paginated,
        ]);
    }
}
