...
class DispensingEncounter extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->toecode == 'WALKN') {
            $orders = DB::select("SELECT docointkey, pcchrgcod, dodate, pchrgqty, estatus, qtyissued, pchrgup, pcchrgamt, drug_concat, chrgdesc, remarks, mssikey, tx_type, prescription_data_id
                                    FROM henctr enctr
