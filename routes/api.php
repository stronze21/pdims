...
Route::prefix('portal')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/prescriptions/reactivated-today', [PortalPrescriptionController::class, 'reactivatedToday']);
        Route::get('/prescriptions/reactivates-tomorrow', [PortalPrescriptionController::class, 'reactivatesTomorrow']);
